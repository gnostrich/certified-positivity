...
a statement comparator) to check that the sorry-free proofs in `RequestProject/` prove
...
/-- From `RequestProject/R_A1.lean` (`TierR.schur_pos_isPDq`).
...
/-- From `RequestProject/R_A3_A4.lean` (`TierR.GramState.expand_pd`).
...
/-- From `RequestProject/R_A3_A4.lean` (`TierR.GramState.halt_not_pd`).
...
/-- From `RequestProject/R_A5.lean` (`TierR.isPDq_iff_nMinus_nZero_eq_zero`).
...
/-- From `RequestProject/R_B1.lean` (`TierR.checkPDq_sound`).
...
/-- From `RequestProject/R5.lean` (`R5.PsiArch_not_convex`).
...
/-- From `RequestProject/R5.lean` (`R5.coverage_prime_free`).
...
/-- From `RequestProject/R5Prime.lean` (`R5.gershgorin_margin`).
...
/-- From `RequestProject/R5Prime.lean` (`R5.coverage_band`). Two-site coverage of the band. -/
...
/-- From `RequestProject/R5Final.lean` (`R5.three_grid_last_row_gershgorin_zero`).
...
/-- From `RequestProject/R5Final.lean` (`R5.coverage_band_final`, stated identically as
...
/-- From `RequestProject/R5Final.lean` (`R5.frontier_covers_band_final`).
